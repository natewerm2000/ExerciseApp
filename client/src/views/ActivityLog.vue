...
<div class="box">
  ...
  <div class="title has-text-grey is-5">Activity Log</div>
</div>
 
 
<div class="control">
                      Enter what kind of workout you did:<div class="select is-fullwidth" type="activity">
                          <select>
 ...
 <div class="field">
            <div class="control">
              <input class="input is-large" type="description" placeholder="description">
            </div>
          </div>
          <div class="field">
            <div class="control">
